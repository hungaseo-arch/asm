...
/** 수량 — 항상 정수. 예) 1,200 EA */
export function formatQty(value, unit = 'EA') {
...
export function formatUnitPrice(currency, value, unit = 'EA') {
 ...
 */
export function formatIdrFull(value) {
...
export function groupAmountInput(raw) {
