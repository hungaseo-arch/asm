...
declare global {
  interface Window {
    __ASM_APP_CONFIG__?: RuntimeAppConfig
    __SKYBASE_APP_CONFIG__?: RuntimeAppConfig
  }
}
...
const runtimeConfig: RuntimeAppConfig =
  window.__ASM_APP_CONFIG__ ?? window.__SKYBASE_APP_CONFIG__ ?? {}

const RAW_API_BASE_URL =
  (import.meta.env.VITE_API_BASE_URL as string | undefined) ?? runtimeConfig.apiBaseUrl ?? ''
